...
export default function StatCard({ label, value, trend, trendColor, icon }) {
  const trendClass = trendColorMap[trendColor] ?? 'text-gray-500'
    ...
    <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className={`text-xs mt-1.5 font-medium ${trendClass}`}>{trend}</p>
        </div>
