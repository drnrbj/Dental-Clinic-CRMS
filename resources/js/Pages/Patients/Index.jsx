                ...
                <tr>
                  <td colSpan={8}>
                    <EmptyState
                      ...
                      actionLabel={can(user, 'patients.create') ? 'Add Patient' : undefined}
                      onAction={can(user, 'patients.create') ? () => setModalOpen(true) : undefined}
                    />
                  </td>
                </tr>
              ) : (
